...
export default function Footer() {
    return (
        <>
        <div className="w-[12rem] h-[0.8rem] mt-[8rem] bg-black/40 rounded-[1.6rem]"></div>
        <div className="max-w-[768px] px-[6.4rem] w-full mt-[8rem] flex flex-col text-[1.6rem] mb-[12.8rem]">
