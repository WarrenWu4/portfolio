...
export default function Nav() {
    ...
    return (
        <nav className="max-w-[768px] mt-[3.2rem] h-[5rem] flex justify-between items-center w-full px-[1.6rem] small:px-[3.2rem] med:px-[6.4rem] font-bold text-[1.8rem] text-black/70 ">
