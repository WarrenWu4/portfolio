...
export const MyMusic = () => {
    ...
    const SpotifyCard = (track:any) => {
        ...
        return (
        <motion.a initial="hidden" whileInView="visible" viewport={{once: true}} transition={{duration:timer, ease:"easeInOut"}} variants={variants} href={track.track.uri} target={"_blank"} className="w-full rounded-[1.2rem] shadow-elevate dark:shadow-elevate-dark p-[1.6rem] cursor-pointer flex items-center hover:scale-105 transition">
