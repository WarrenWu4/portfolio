...
export default function Navbar() {
    ...
    return (
        <nav className="w-full p-4 border-4 flex items-center justify-between bg-orange-100">

            <div className="flex items-center gap-x-2 small:gap-x-4 text-2xl font-bold">
                <NavLink to={"/"}>
